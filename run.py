...
def done(chosen_images, images, name):
    s3 = boto3.resource(
        ...
        aws_access_key_id= ${{ secrets.AWS_ACCESS_KEY_ID }} , #os.environ['AWS_ACCESS_KEY_ID'] ,
        aws_secret_access_key= ${{ secrets.AWS_SECRET_ACCESS_KEY }} #os.environ['AWS_SECRET_ACCESS_KEY']
    )
